                    ...
                    <div class="box-logo">
                        <a href="{{route('home.index')}}" id="site-logo-inner">
                            <img class="" id="logo_header_1" alt="" src="{{asset('assets/images/logo2.png')}}"
                                data-light="{{asset('assets/images/logo2.png')}}" data-dark="{{asset('assets/images/logo2.png')}}">
                        </a>
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{asset('assets/images/logo2.png')}}"
                                        data-light="{{asset('assets/images/logo2.png')}}" data-dark="{{asset('assets/images/logo2.png')}}"
                                        data-width="154px" data-height="52px" data-retina="{{asset('assets/images/logo2.png')}}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="{{asset('assets/images/logs.png')}}" alt="">
                                                </span>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <a href="{{route('admin.contacts')}}" class="user-item">
                                                    ...
                                                    <div class="number">
                                                        @if ($message > 0 )
                                                            <span class="cart-amount d-block position-absolute js-cart-items-count">{{$message}}</span>
                                                        @endif
                                                    </div>
                                                </a>
                                            </li>
